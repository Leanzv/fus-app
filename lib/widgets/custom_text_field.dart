...
class CustomTextField extends StatelessWidget {
  ...
  const CustomTextField({super.key, required this.controller, required this.label,
    required this.hint, this.prefixIcon, this.suffixIcon, this.obscureText = false,
...
class LoadingButton extends StatelessWidget {
  ...
  const LoadingButton({super.key, required this.isLoading, required this.onPressed,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(backgroundColor: color ?? AppTheme.primaryColor),
        child: isLoading
...
class SportFilterChip extends StatelessWidget {
  ...
  const SportFilterChip({super.key, required this.label, required this.isSelected, required this.onTap});
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected ? [BoxShadow(color: AppTheme.primaryColor.withOpacity(0.25),
