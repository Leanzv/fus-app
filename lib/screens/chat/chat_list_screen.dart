    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        data: (profile) {
          ...
          final bookingsAsync = ref.watch(userBookingsProvider(profile.id));
            ...
            data: (bookings) {
              if (bookings.isEmpty) {
                return const Center(child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text('Belum ada booking', style: TextStyle(
              ...
              return ListView.builder(
                ...
                itemBuilder: (_, i) => _ChatTile(
                  booking: bookings[i],
                  onTap: () => context.push('/chat/${bookings[i].id}',
                      extra: bookings[i]),
                ),
              );
            },
...
// ─── Tile booking di list chat ────────────────────────────────
class _ChatTile extends StatelessWidget {
  final BookingModel booking;
  final VoidCallback onTap;
  const _ChatTile({required this.booking, required this.onTap});
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(booking.message, maxLines: 1, overflow: TextOverflow.ellipsis,
              style: const TextStyle(fontSize: 12, color: AppTheme.textSecondary)),
        ]),
        trailing: Container(
          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
          decoration: BoxDecoration(color: booking.statusColor.withOpacity(0.1),
              borderRadius: BorderRadius.circular(8)),
          child: Text(booking.statusLabel, style: TextStyle(color: booking.statusColor,
