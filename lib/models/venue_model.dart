class VenueModel {
  ...
  VenueModel({
    ...
    this.imageUrl, this.averageRating, this.reviewCount,
    this.createdAt, this.distanceKm,
  });
  ...
  factory VenueModel.fromJson(Map<String, dynamic> json) {
    return VenueModel(
      ...
      averageRating: json['average_rating'] != null
          ? (json['average_rating'] as num).toDouble() : null,
  ...
  Map<String, dynamic> toJson() => {
    'owner_id': ownerId, 'name': name, 'type': type,
    'description': description, 'latitude': latitude,
    'longitude': longitude, 'image_url': imageUrl,
  };

  VenueModel copyWith({String? name, String? type, String? description,
    double? latitude, double? longitude, String? imageUrl,
    double? averageRating, int? reviewCount, double? distanceKm}) {
    return VenueModel(
...
const List<String> sportTypes = [
  'Futsal', 'Badminton', 'Basket', 'Renang', 'Tenis',
  'Voli', 'Gym / Fitness', 'Skate Park', 'Climbing', 'Golf', 'Lainnya',
];
